              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    getPositionRow(
                        getPlayerMedicsPickedPosition(),
                        "${applicationLocalization.getText("log_class_overall_top_medics_killed")}",
                        context)
                  ]),
                  Row(children: [
                    getStatRow(
                    ...
                    getPositionRow(
                        getPlayerCapPosition(),
                        "${applicationLocalization.getText("log_class_overall_top_caps")}",
                        context)
                  ]),
                ],
              ))),
